...
class MatchthefollowController extends CI_Controller {
    ...
    public function MatchtheFollow() {
       ...
       $data['difficulty_level'] = $this->addQuestionModel->get_levelid();
        ...
        $this->load->view('MatchthefollowView', $data);
    }
