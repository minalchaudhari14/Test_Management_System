...
option_data.push(arry2);
    ...
    //Store sequence in json array in one field
     sequence_data = new Array();
    var arry1={};
var arr = [];
arry1.CorrectSequence=$("input[name='sequence[]']").map(function () {
 return $(this).val();
    }).get();
data.append('sequence', JSON.stringify(arr));
sequence_data.push(arry1);
    data.append('sequence_data', JSON.stringify(sequence_data));
